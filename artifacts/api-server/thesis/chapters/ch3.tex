...
\begin{enumerate}
  ...
  \item Сервер \texttt{INSERT shared\_cart\_items}, дараа нь
    \texttt{io.to(`session\_\$\{qrToken\}`).emit(``cart:updated'', items)}
    broadcast хийнэ.
...
\begin{itemize}
  ...
  \item \textbf{AR (Augmented Reality) хоолны үзүүлбэр:} \texttt{model-viewer}
    компонент дээр 29\% (scale 0.000435) хувийн хэмжээгээр хоолны 3D загвар
    харуулах боломж нэмэгдсэн.
